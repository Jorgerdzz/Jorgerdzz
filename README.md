...
Soy un **Desarrollador Full Stack y Cloud** apasionado por la tecnología, la creación de soluciones innovadoras y la construcción de aplicaciones eficientes, escalables y seguras.
...
- Desarrollo de aplicaciones web y móviles interactivas (Windows, Mac, Android, iOS)  
- Diseño e implementación de aplicaciones seguras con tecnologías .NET y .NET Core  
- Programación orientada a objetos avanzada (Java, C#)  
- Desarrollo y consumo de **APIs REST** usando JSON y XML  
- Acceso y manipulación de datos remotos con ADO.NET y Entity Framework  
